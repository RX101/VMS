...
public class HostHomePage extends AppCompatActivity {
    ...
    private String apikey, visitor_name,visitor_email,handphone_number, msg,block,unit;
...
//ps
        btnPreregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentToPreRegister = new Intent(HostHomePage.this, HostPreRegister.class);
                intentToPreRegister.putExtra("block",block);
                intentToPreRegister.putExtra("unit",unit);
                startActivity(intentToPreRegister);
            }
        });
